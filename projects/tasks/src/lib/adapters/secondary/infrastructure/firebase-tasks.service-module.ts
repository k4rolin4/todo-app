...
@NgModule({ imports: [AngularFirestoreModule],
  	declarations: [],
  	providers: [FirebaseTasksService, { provide: GETS_ALL_TASK_DTO, useExisting: FirebaseTasksService }, { provide: ADDS_TASK_DTO, useExisting: FirebaseTasksService }, { provide: SETS_TASK_DTO, useExisting: FirebaseTasksService }, { provide: REMOVES_TASK_DTO, useExisting: FirebaseTasksService }],
  	exports: [] })
